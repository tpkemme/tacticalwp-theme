...
<header id="front-hero" role="banner">
	<div class="marketing">
		<div class="tagline">
			...
			<a role="button" class="download large button sites-button hide-for-small-only" href="https://github.com/tpkemme/solwp">Download SolWP</a>
		</div>

		<div id="watch">
			<section id="stargazers">
				<a href="https://github.com/tpkemme/solwp">1.5k stargazers</a>
			</section>
			<section id="twitter">
